        ...
        <div class="shadow items-center overflow-hidden border-gray-200 sm:rounded-lg">
          <div class="bg-white px-4 py-5 sm:px-3">
            <div class="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
              <div class="ml-4 mt-2">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Vocabulary {{ vocabID }} / Entities</h3>
              </div>
          ...
          <table class="min-w-full max-w-full">
            ...
            <tbody>
              <tr class="" v-for="entity in entities" :key="entity.id">
                ...
                <td class="px-3 py-3 text-sm whitespace-nowrap text-center font-medium text-gray-900">
